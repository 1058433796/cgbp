...
class CausalMetric():
    ...
    def single_run(self, img_tensor, saliency_map, device, target_class=None,max_batch_size=50):
        ...
        if target_class is None: target_class = index[0]
